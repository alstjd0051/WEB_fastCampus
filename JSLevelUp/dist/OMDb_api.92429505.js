...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"OMDb_api.js":[function(require,module,exports) {
"use strict";
...
function fetchMovies() {
  _axios.default.get('https://www.omdbapi.com/?apikey=7035c60c&s=Guardians of the Galaxy').then(function (res) {
    console.log(res);
    var h1El = document.querySelector('h1');
    var imgEl = document.querySelector('img');
    h1El.textContent = res.data.Search[2].Title;
    imgEl.src = res.data.Search[2].Poster;
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3335" + '/');
...
//# sourceMappingURL=/OMDb_api.92429505.js.map